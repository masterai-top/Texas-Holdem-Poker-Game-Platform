#ifndef __RANK_BOARD_CONFIG_DELETE_H__
#define __RANK_BOARD_CONFIG_DELETE_H__
class RankBoardConfigDeleteRequest
{
public:
    RankBoardConfigDeleteRequest(const string &json)
    {
...
class RankBoardConfigDeleteResponse
{
public:
    RankBoardConfigDeleteResponse(const string &json)
    {
        this->Deserialize(json);
    }
    template <typename Writer>
